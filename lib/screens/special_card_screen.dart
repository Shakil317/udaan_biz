...
class SpecialCardScreen extends StatefulWidget {
  final int? id;
  final String? name;
  final String? usersData;

  const SpecialCardScreen({super.key, this.id, this.usersData, this.name});

  @override
  State<SpecialCardScreen> createState() => _SpecialCardScreenState();
}

class _SpecialCardScreenState extends State<SpecialCardScreen> {
              ...
              child: Consumer<UserProfileProvider>(
                builder: (context, value, child) {
                  ...
                  final List<Map<String, dynamic>> cardData = [
                    ...
                    {
                      "about": "जहाँ संतुष्टि मिले पूरी – वही है सही चुनाव!",
            ...
            child: SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () {
                 ...
                 // provider.handlePaymentSuccess(context, onPaymentSuccess: () { creditProvider.captureAndSharePDF();});
                ...
                label:
                const Text("Pay And Continue", style: TextStyle(color: Colors.white)),
