...
import 'package:mycalculator/screens/real_downloder_pdf_screen.dart';
...
class RealTransitionHistoryScreen extends StatefulWidget {
  final String? name;
  final String? id;
  final String? imagePr;
  final String number;
  final double? totalAmount;
  const RealTransitionHistoryScreen({super.key, this.name, this.id, this.imagePr, required this.number, this.totalAmount});

  @override
  State<RealTransitionHistoryScreen> createState() => _RealTransitionHistoryScreenState();
}

class _RealTransitionHistoryScreenState extends State<RealTransitionHistoryScreen> {
  TextEditingController controllerType = TextEditingController();
  @override
  void initState() {
    super.initState();
    Provider.of<RealTransitionHistoryProvider>(context, listen: false).setCustomer(widget.id);
    Provider.of<RealTransitionHistoryProvider>(context,listen: false).fetchTransitions();
  }
  @override
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
          ...
          leading: Padding(
            ...
            child: CircleAvatar(
              ...
              child: CircleAvatar(
                ...
                backgroundImage: (widget.imagePr != null && widget.imagePr!.isNotEmpty)
                    ? NetworkImage((widget.imagePr!))
                    : null,
                child: (widget.imagePr == null || widget.imagePr!.isEmpty)
                    ? Text(
            ...
            IconButton(
              ...
              onPressed: () {
                AppRoot.appRoutePush(
                  context: context,
                  page: RealDownloaderPdfScreen(name: widget.name ?? ""),
                );
              },
            ),
          ],
        ),
        body: Consumer<RealTransitionHistoryProvider>(builder: (context, data, child) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              bool isReceived = item.isReceived == 'isReceived';
              return isReceived ?
              Padding(
                ...
                child: GestureDetector(
                  ...
                  onLongPress: () {
                    AppRoot.appAlertDialog(
                      ...
                      toastMes: "Delete",
                      onConfirm: () {
                        // data.deleteTransition(data.transitionList[index].transitionId.toString());
                        data.deleteTransitionWithAuth(context, data.transitionList[index].transitionId.toString());
                              ...
                              IconButton(
                                ...
                                onPressed: () async{
                                  String presetMessage =
                                      "नमस्ते ${widget.name}, आज आपने ₹${item.receivedMoney ?? '00'} जमा किए हैं। आपके विश्वास और भुगतान के लिए धन्यवाद!${profileProvider.userProfile[0].shopName}";
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: ()async {
                                  String presetMessage =
                                      "नमस्ते ${widget.name}, आज ₹${item.loanedMoney ?? '00'} की एंट्री आपके उधारी खाते में जोड़ी गई है। कृपया अपनी नोटबुक में भी दर्ज कर लें। धन्यवाद!${profileProvider.userProfile[0].shopName} 🙏";
                                  final sms = Uri.parse(
                                      'sms:${widget.number.toString()}?body=${Uri.encodeComponent(presetMessage)}');
                                  if (await canLaunchUrl(sms)) {
                                    launchUrl(sms);
        ...
        bottomNavigationBar: Consumer<RealTransitionHistoryProvider>(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            showAppDialog(dialogTitle: 'Receive Money', controllerType: value.receiveAmountController, states: 'isReceived');
                          },
                          child: Padding(
                          ...
                          children: [
                            Center(
                              child: Padding(
                                ...
                                child: Text("\u20B9 ${value.transitionList.isEmpty ? 0.0 : value.yourCollectionData}",
                                  style: TextStyle(
                                      fontSize: 20,
                    ...
                    Row(
                      ...
                      children: [
                        GestureDetector(
                          onTap: () {
                            showAppDialog(dialogTitle: 'Loaned Money', controllerType: value.loanedAmountController, states: 'isLoaned');
                          },
                          child:
                          Padding(
                            padding: const EdgeInsets.only(bottom: 0),
  ...
  void showAppDialog({
    ...
    var realTransition = Provider.of<RealTransitionHistoryProvider>(
      context,
      listen: false,
    );
    showDialog(
                      ...
                      children: [
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            height: 45,
                            child: TextField(
                              controller: realTransition.dateController,
                              ...
                              decoration: InputDecoration(
                                ...
                                prefixIcon: IconButton(
                                  onPressed: () {
                                    realTransition.selectedDate(context);
                                  },
                                  icon: const Icon(
                                    Icons.date_range,
                                    color: AppThem.appBgColor,
                        ...
                        SizedBox(
                          ...
                          height: 45,
                          child: TextField(
                            controller: realTransition.timeController,
                            keyboardType: TextInputType.datetime,
                            style: const TextStyle(color: AppThem.appBgColor),
                            decoration: InputDecoration(
                              border: const OutlineInputBorder(
                              ...
                              prefixIcon: IconButton(
                                onPressed: () {
                                  realTransition.selectedTime(context);
                                },
                                icon: const Icon(
                      ...
                      children: [
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: TextField(
                              maxLength: 25,
                              controller: realTransition.productRemarkController,
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            if (controllerType.text.isNotEmpty ||
                                realTransition.productRemarkController.text.isNotEmpty) {realTransition.addNewTransition(context, status: states.toString(),);
                            Navigator.pop(context);
                            } else {
